      ...
      <LanguageProvider>
        <Router>
          ...
          <Routes>
                        ...
                        <Route path="/admin/services" element={<ProtectedRoute><Suspense fallback={<div className="min-h-screen bg-[#e8e5e6] flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-gray-400" /></div>}><ServicesAdminPage /></Suspense></ProtectedRoute>} />
                        ...
                        <Route path="/blog/admin" element={<ProtectedRoute><Suspense fallback={<div className="min-h-screen bg-[#e8e5e6] flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-gray-400" /></div>}><AdminBlogPage /></Suspense></ProtectedRoute>} />
                        <Route path="/admin/users" element={<ProtectedRoute requiredRole="ADMIN"><Suspense fallback={<div className="min-h-screen bg-[#e8e5e6] flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-gray-400" /></div>}><AdminUsersPage /></Suspense></ProtectedRoute>} />
                        <Route path="/admin/coupons" element={<ProtectedRoute requiredRole="ADMIN"><Suspense fallback={<div className="min-h-screen bg-[#e8e5e6] flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-gray-400" /></div>}><AdminCouponsPage /></Suspense></ProtectedRoute>} />
