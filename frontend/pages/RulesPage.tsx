  ...
  return (
    <div className="max-w-3xl mx-auto px-3 sm:px-6 lg:px-8 py-8">
             <div className="text-center mb-8">
                <h1 className="text-[22px] md:text-[28px] font-bold text-gray-900 leading-[1.25] mb-3">{data.titles.rules}</h1>
                <p className="text-[14px] md:text-[16px] text-gray-500 leading-[1.6]">{data.titles.rulesSubtitle}</p>
      </div>
